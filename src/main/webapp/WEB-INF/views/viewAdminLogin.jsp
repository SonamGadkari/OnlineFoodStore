...
<nav class="navbar card-header navbar-inverse">
        ...
        <div class="col col-lg-1 btn float-right login_btn">
        <a class="navbar-link js-scroll-trigger" href="<c:url value="/viewLogin" />#services">User-Login</a>
         </div>
        <div class="col col-lg-1 btn float-right login_btn">
            ...
            <div class="card-body">
                <form id="form_id" method="post" name="myform">
                    ...
                    <div class="form-group">
                        ...
                        if (username == "admin879" && password == "bearcat")
                        {
                        window.alert("Login successful");
                        window.location = "<c:url value="/viewCRUD" />#page-top"; // Redirecting to other page.
                        return false;
                        }
                        else if (username == "")
                                {
                        ...
                        {
                                window.alert("Login successful");
                                window.location = "<c:url value="/viewCRUD" />#page-top";
                        }
